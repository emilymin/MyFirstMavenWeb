...
public class Constant {
    ...
    public static final String Pizza_Flavour_Mockba = "Mockba";
    public static final String Pizza_Flavour_Cheese = "Cheese";
    public static final String Pizza_Flavour_Neapolitan = "Neapolitan";
